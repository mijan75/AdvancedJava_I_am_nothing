...
import bd.ac.seu.mijan.security.SecurityUtils;
import com.codahale.metrics.annotation.Timed;
import bd.ac.seu.mijan.domain.Student;

import bd.ac.seu.mijan.repository.StudentRepository;
...
import static bd.ac.seu.mijan.security.AuthoritiesConstants.ADMIN;
...
public class StudentResource {
    ...
    public ResponseEntity<Student> createStudent(@RequestBody Student student) throws URISyntaxException {
        if(!SecurityUtils.isCurrentUserInRole(ADMIN)){
            return ResponseEntity.badRequest().headers(HeaderUtil.createFailureAlert(ENTITY_NAME, "not-authenticated", "you need to log in as a user")).body(null);
        }
