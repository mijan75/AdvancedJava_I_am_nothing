package bd.ac.seu.mijan.repository;

import bd.ac.seu.mijan.MijanApp;
import bd.ac.seu.mijan.config.Constants;
import bd.ac.seu.mijan.config.audit.AuditEventConverter;
import bd.ac.seu.mijan.domain.PersistentAuditEvent;
...
import static bd.ac.seu.mijan.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
